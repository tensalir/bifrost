  ...
  return (
    <div className="space-y-8">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>
                  ...
                  {!setup.checks.routingMap && (
                    <Link href="/admin/routing" className="ml-2 text-primary hover:underline">
                      Configure →
                    </Link>
                  )}
                </span>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard title="Queued" value={stats?.queued ?? 0} icon={Clock} href="/admin/jobs?state=queued" />
        <StatCard title="Running" value={stats?.running ?? 0} icon={Activity} href="/admin/jobs?state=running" />
        <StatCard title="Completed" value={stats?.completed ?? 0} icon={CheckCircle2} href="/admin/jobs?state=completed" />
        <StatCard title="Failed" value={stats?.failed ?? 0} icon={XCircle} href="/admin/jobs?state=failed" />
      </div>
