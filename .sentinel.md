# Sentinel: Bifrost Development Best Practices

> Evergreen principles learned from real bugs in the Bifrost Figma plugin + backend system.
...
- `fillTextNodes` is only needed for bifrostId-based fallback (legacy path without mapping)
...
*Principles learned from Bifrost Figma plugin debugging, 2026-02-12/13.*
